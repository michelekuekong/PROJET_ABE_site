...
ABSTRACT class General {
    ...
    protected function getSms($resultat){
        ...
        if(empty($resultat)){
            $msg='<div class="alert alert-warning alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert">&times;</button>
                  <strong><i class="fa fa-stop-circle" aria-hidden="true"></i> </strong> Echec:  Verifiez si cette valeur existe déjà et réessayer!
                </div>';

        }else{
            $msg='<div class="alert alert-success alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert">&times;</button>
                  <strong><i class="fa fa-check" aria-hidden="true"></i> </strong> Effectué avec succès !
                </div>';
        }
     return $msg;
    }
    protected function getCheck_email_phone($resultat){
        ...
        if(empty($resultat)){
            $msg='<div class="alert alert-warning alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert">&times;</button>
                  <strong><i class="fa fa-stop-circle" aria-hidden="true"></i> </strong> Nom éffectué Verifier si l"email ou le munero de telephone sont entrés dans le bon format ou s"il n"existe pas deja et réessayer !
                </div>';
        }else{
            $msg='<div class="alert alert-success alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert">&times;</button>
    ...
    protected function getCheck_email($resultat){
        ...
        if(empty($resultat)){
            $msg='<div class="alert alert-warning alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert">&times;</button>
                  <strong><i class="fa fa-stop-circle" aria-hidden="true"></i> </strong> Nom éffectué Verifier si l"email est entrés dans le bon format ou s"il n"existe pas deja et réessayer exemple crick@yahoo.con !
                </div>';
        }else{
            $msg='<div class="alert alert-success alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert">&times;</button>
