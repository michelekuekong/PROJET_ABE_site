<?php
class Produit_prestation extends General {
...
private function getParam(){
    extract($_POST);
    $titre=str_replace("'", "\'", htmlspecialchars($titre));
    $timing=str_replace("'", "\'", htmlspecialchars($timing));  
        $param[0]['col']='titre';
        $param[0]['val']=ucfirst($titre);
        $param[1]['col']='id_prestation';
        $param[1]['val']=$id_prestation;
        $param[2]['col']='prix';
        $param[2]['val']=(int) $prix;
        $param[3]['col']='timing';
        $param[3]['val']=$timing;
        $param[4]['col']='online';
        $param[4]['val']=0;
