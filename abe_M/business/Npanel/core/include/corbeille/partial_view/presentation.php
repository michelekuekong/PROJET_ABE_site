        ...
        <table id="zero_config" class="table table-striped table-bordered">
            <thead>
                <tr style="">
                    ...
                    <th style="width:25%;text-align:center;font-weight:1000">Rubrique</th>
            ...
            <tbody>
                <?php foreach ($data as $key => $value){ ?> 
                    <?php $position = $this->getColsByCol('position_presentation', 'nom', 'id', $value->getId_position()); ?>
                    <tr>
                        <td> <?= $key+1 ?></td>
                        <td><?= str_replace("\'", "'",  $value->getRubrique() )?></td>
