...
ABSTRACT CLASS db{
    ...
    private static function setBdd(){
       self::$_bdd = NEW PDO('mysql:host=localhost;dbname=abe_business', 'root','' , array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES UTF8'));
...
**/
    ...
    protected function UpdateById($table,$id,$param){
...
protected function GetAlln($table,$param,$obj){
    ...
    $req->closeCursor;
      ...
      protected function getOneColbyOneCol($table,$cols,$col,$val){
        $this->getBbd();
        $var=array();
        $i=0;
        $req=self::$_bdd->prepare("SELECT ".$cols." FROM  ".$table." WHERE ".$col." ='".$val."'" );
...
protected function GetAllnAndDif ( $table, $param, $paramDif, $obj ) {
            $this->getBbd();
