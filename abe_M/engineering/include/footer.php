        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              ...
              <p><i class="fa fa-map-marker" aria-hidden="true"></i> <?= (!empty($data_entreprise[0]->getAdresse())) ? $data_entreprise[0]->getAdresse() : "" ; ?></p>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="index.php?action=News">Actualités</a></li>
