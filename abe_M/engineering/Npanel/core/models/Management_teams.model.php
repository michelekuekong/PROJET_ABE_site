...
class Management_teams{
   ...
   public function setId($id){
    ...
    public function setFonction($fonction){
      $this->_fonction=stripslashes($fonction);
    }
    public function setNom($nom){
      $this->_nom=stripslashes($nom);
    }
    public function setCompte_facebook($compte_facebook){
      $this->_compte_facebook=stripslashes($compte_facebook);
    }
    public function setCompte_twitter($compte_twitter){
      $this->_compte_twitter=stripslashes($compte_twitter);
    }

    public function setCompte_instagram($compte_instagram){
      $this->_compte_instagram=stripslashes($compte_instagram);
    }

    public function setCompte_linkedin($compte_linkedin){
      $this->_compte_linkedin=stripslashes($compte_linkedin);
    }
    ...
    public function setDepartement($departement){
      $this->_departement=stripslashes($departement);
    }
